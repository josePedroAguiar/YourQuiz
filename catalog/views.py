...
def _505_(request):
    if request.method == 'GET':
        return render(request,'next.html',{'clue':"Parabéns,Rita! :)) Espero que saibas  que tanto o teu namorado como a tua irmã gostamos muito de ti.Por isso, decidimos ambos em te oferecer o bilhete para o Kalorama onde podes ver os Arctic Monkeys :)"})
